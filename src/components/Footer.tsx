          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <svg className="h-6 w-6 text-cyan-400 mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:info@plantandtruckrepairs.com.au" className="text-gray-400 hover:text-cyan-400 transition-colors">
                  info@plantandtruckrepairs.com.au
                </a>
              </li>
              <li className="flex items-center">
                <svg className="h-6 w-6 text-cyan-400 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
