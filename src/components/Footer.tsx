        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex space-x-3">
              <a
                href="#"
                className="w-10 h-10 bg-gray-800 hover:bg-amber-600 rounded-lg flex items-center justify-center transition-all duration-300 hover:-translate-y-1"
                aria-label="Facebook"
              >
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={service}>
                  ...
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-gray-600 group-hover:text-amber-400 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+61468601750" className="text-gray-400 hover:text-amber-400 transition-colors">
                  +61 468 601 750
                </a>
              </li>
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:plantandtruckrepairs@gmail.com" className="text-gray-400 hover:text-amber-400 transition-colors text-sm">
