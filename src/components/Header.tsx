...
export default function Header() {
  ...
  return (
    ...
    >
      {/* Top accent line */}
      <div className="absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r from-transparent via-amber-500 to-transparent opacity-60"></div>
      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center">
          ...
          <nav className="hidden md:flex items-center space-x-2 lg:space-x-6">
            <Link
              href="/"
              className="relative text-white hover:text-amber-400 font-medium px-3 py-2 transition-all duration-300 group"
            >
              <span>Home</span>
            ...
            <a
              ...
              className="ml-4 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white px-5 py-2.5 rounded-lg flex items-center transition-all duration-300 shadow-lg hover:shadow-amber-500/30 hover:-translate-y-0.5 font-medium"
            >
        ...
        >
          <nav className="py-4 px-2 mt-2 bg-gradient-to-b from-gray-800/95 to-gray-900/95 backdrop-blur-sm rounded-xl border border-gray-700/50">
            <div className="flex flex-col space-y-1">
              <Link
                href="/"
                className="text-white hover:text-amber-400 px-4 py-3 rounded-lg hover:bg-white/5 font-medium transition-all duration-200"
              ...
              <div className="pt-2 mt-2 border-t border-gray-700/50">
                <a
                  href="tel:+61468601750"
                  className="bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white px-4 py-3 rounded-lg flex items-center transition-all duration-300 justify-center font-medium shadow-lg"
                  onClick={() => setIsMenuOpen(false)}
                >
